...
Данные для входа в Metabase и подключения к PostgreSQL предоставляются отдельно при сдаче проекта.
...
* [Презентация](reports/assortment_research_2023.pptx)
...
* [Jupyter Notebook](notebooks/02_customer_analysis_2023.ipynb)
* [Презентация](reports/customer_ltv_research_2023.pptx)
